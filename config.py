...
class Config:
    ...
    def __init__(self, db_path: Path, gee_project_name: Optional[str] = None) -> None:
        ...
        self.max_epochs_count_without_improvement = 20  # if the val loss does not improve for 20 epochs: stop training (could be done with an early stopping class with epsilon)
